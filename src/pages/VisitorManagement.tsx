...
const VisitorManagement: React.FC = () => {
  ...
  const visitorData = [
    { 
      ...
      name: '刘建华', 
      // phone: '13705379001',
      idCard: '370882197501015234',
      company: '患者家属',
      visitPurpose: '探视患者',
      visitee: '刘明',
      visitDepartment: '内科病区',
      checkInTime: '2025-08-29 09:30:00', 
      checkOutTime: '2025-08-29 11:00:00',
      status: '已离开', 
    ...
    { 
      ...
      name: '汪柯美', 
      // phone: '13705379002',
      idCard: '370882198203025647',
      company: '济宁市第一人民医院',
      visitPurpose: '学术交流',
      visitee: '张琴',
      visitDepartment: '外科',
      checkInTime: '2025-08-29 14:30:00', 
      checkOutTime: '',
      status: '在院内', 
      photo: '/api/placeholder/60/60',
    ...
    { 
      ...
      name: '陈文龙', 
      // phone: '13705379003',
      idCard: '370882196812035869',
      company: '电梯维修公司',
      visitPurpose: '设备维护',
      visitee: '刘湘',
      visitDepartment: '后勤科',
      checkInTime: '2025-08-29 10:00:00', 
      checkOutTime: '2025-08-29 11:30:00',
      status: '已离开', 
      photo: '/api/placeholder/60/60',
    ...
    { 
      ...
      name: '李志鑫', 
      // phone: '13705379004',
      idCard: '370882197409046984',
      company: '患者家属',
      visitPurpose: '陪护患者',
      visitee: '李浩',
      visitDepartment: '儿科',
      checkInTime: '2025-08-29 08:00:00', 
      checkOutTime: '',
      status: '在院内', 
      photo: '/api/placeholder/60/60',
    ...
    { 
      ...
      name: '张宏全', 
      // phone: '13705379005',
      idCard: '370882198606056952',
      company: '山东康源医药',
      visitPurpose: '药品配送',
      visitee: '杨富强',
      visitDepartment: '药剂科',
      checkInTime: '2025-08-29 07:30:00', 
      checkOutTime: '2025-08-29 08:15:00',
      status: '已离开', 
      photo: '/api/placeholder/60/60',
    ...
    { 
      ...
      name: '赵健', 
      // phone: '13705379006',
      idCard: '370882197807066324',
      company: '县卫健局',
      visitPurpose: '工作检查',
      visitee: '张利军',
      visitDepartment: '院办',
      checkInTime: '2025-08-28 15:00:00', 
      checkOutTime: '2025-08-28 17:00:00',
      status: '已离开', 
      photo: '/api/placeholder/60/60',
    ...
    },
    {
      ...
      name: '孙大明',
      // phone: '13705379007',
      idCard: '370882195012076195',
      company: '患者家属',
      visitPurpose: '探视患者',
      visitee: '马保国',
      visitDepartment: '心内科',
      checkInTime: '2025-08-28 14:30:00',
      checkOutTime: '2025-08-28 16:00:00',
      status: '已离开',
      photo: '/api/placeholder/60/60',
    ...
    },
    {
      ...
      name: '马云东',
      // phone: '13705379008',
      idCard: '370882198509086643',
      company: '医疗设备公司',
      visitPurpose: '设备安装',
      visitee: '李东旭',
      visitDepartment: '设备科',
      checkInTime: '2025-08-28 13:00:00',
      checkOutTime: '2025-08-28 15:30:00',
      status: '已离开',
      photo: '/api/placeholder/60/60',
    ...
    },
    {
      ...
      name: '田阿杜',
      // phone: '13705379009',
      idCard: '370882198710096741',
      company: '兖州日报',
      visitPurpose: '新闻采访',
      visitee: '张波',
      visitDepartment: '宣传科',
      checkInTime: '2025-08-28 10:00:00',
      checkOutTime: '2025-08-28 11:30:00',
      status: '已离开',
      photo: '/api/placeholder/60/60',
  ...
  // 访客统计
  const visitorStats = {
    todayTotal: visitorData.filter(v => v.checkInTime.includes('2025-08-29')).length,
