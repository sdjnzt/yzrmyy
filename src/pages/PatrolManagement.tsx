...
const PatrolManagement: React.FC = () => {
  ...
  const patrolData = [
    { 
      ...
      routeName: '门诊楼日常巡更', 
      patrolUser: '刘建国',
      startTime: '2025-08-29 08:00:00', 
      endTime: '2025-08-29 08:45:00',
      status: '已完成', 
      checkPoints: 8,
      completedPoints: 8,
      duration: '45分钟',
    ...
    },
    {
      ...
      routeName: '手术室专项检查',
      patrolUser: '张伟民',
      startTime: '2025-08-29 07:30:00',
      endTime: '2025-08-29 08:00:00',
      status: '已完成',
      checkPoints: 4,
      completedPoints: 4,
      duration: '30分钟',
    ...
    },
    {
      ...
      routeName: '停车场安全巡查',
      patrolUser: '孙建华',
      startTime: '2025-08-28 15:45:00',
      endTime: '2025-08-28 16:15:00',
      status: '已完成',
      checkPoints: 5,
      completedPoints: 5,
      duration: '30分钟',
